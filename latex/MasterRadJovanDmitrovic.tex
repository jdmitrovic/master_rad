...
\kljucnereci{programski jezici, \textit{Rust}, stabla pretrage,
  prilagodljiva radiks-stabla, algoritmi i strukture podataka}
...
koristiti notaciju \texttt{\_} za obeležavanje podrazumevane grane.
...
Naredba \texttt{match} sa granom \texttt{\_} omogućava
ispisivanje vrednosti komponenti boja koje su pohranjene isključivo u modelu RGB.\

\lstinputlisting[language=Rust,
                 caption={Korišćenje \texttt{match} naredbe sa podrazumevanom granom},
                 label={enum:def_match}]{default_match.rs}
...
\lstinputlisting[language=Rust,
                 caption={Definisanje funkcije čiji parametri imaju eskplicitno navedene životne vekove},
