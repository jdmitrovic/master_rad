...
\begin{description}
  ...
  \item[Node4] Najjednostavniji oblik unutrašnjeg čvora
        i sastoji se od
        dva vektora dužine 4 za bajtove ključa i pokazivača na decu.
  ...
  \item[Node48]
        ...
        dece koji ima kapacitet od 48 elemenata.
...
\begin{figure}[!h]
  ...
  \caption{Četiri tipa unutrašnjeg čvora u strukturi ART.\ Strelicama su povezani
