...
\apstr{
  ...
  poranjuju parove ključ-vrednost. Prilagodljiva radiks-stabla
  ...
  radiks-stablima. Cilj rada je predstavljanje
  implementacije prilagodljivih radiks-stabala u programskom jeziku \textit{Rust},
  koja podržava osnovne operacije: umetanje, čitanje, ažuriranje i brisanje.
  Na kraju rada je prikazano testiranje implementirane strukture podataka,
  kao i poređenje performansi sa drugim strukturama podataka implementiranih
  u programskom jeziku \textit{Rust}.
}

% Ključne reči na srpskom jeziku (u odabranom pismu)
\kljucnereci{programiranje, programski jezici, strukture podataka}
