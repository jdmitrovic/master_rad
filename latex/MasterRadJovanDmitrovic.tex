...
Na slici~\ref{fig:radiks} predstavljeno je radiks-stablo
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.5\textwidth]{images/radiks_stablo.png}
  \caption{Primer radiks-stabla}
  \label{fig:radiks}
\end{figure}

Ukoliko bi se u primeru na
slici~\ref{fig:radiks} dodao par sa ključem \texttt{AN},
...
čvoru \texttt{C}, gde se dobija novo stablo kao na slici~\ref{fig:radiks2}.
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.7\textwidth]{images/radiks_stablo_2.png}
