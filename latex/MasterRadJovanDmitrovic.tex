...
je pridružena i koja podržava upite dometa
...
S druge strane, listovi moraju sadržati vrednost, u suprotnom su suvišni.
Na primeru su čvorovi koji sadrže vrednosti obeleženi žutom bojom.

\begin{figure}[!h]
  \centering
  \includegraphics[width=0.4\textwidth]{images/radix_tree.eps}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.55\textwidth]{images/radix_tree_2.eps}
...
Broj bitova koji unutrašnji čvorovi memorišu se naziva \textbf{opseg} (engl. \emph{span}).
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.55\textwidth]{images/radix_compression.eps}
...
Sve preko unapred određenog broja bajtova tog vektora ne memoriše,
...
\begin{description}
  ...
  \item[Node25] Koristi se niz maksimalne veličine od 256 elemenata
...
$ \lceil \frac{k}{s} \rceil $. Kako je opseg $s$ konstantan i
