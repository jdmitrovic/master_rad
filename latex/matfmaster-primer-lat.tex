...
\begin{lstlisting}[language=TOML, caption={Inicijalna \emph{Cargo.toml} datoteka}]
[package]
name = "novi_projekat"
version = "0.1.0"
...
\texttt{\&'static}. Ukoliko bi se kôd iz listinga~\ref{poz:dangle} pokušao prevesti,
kompilator ne bi dozvolio prevođenje bez
\texttt{static} oznaka. Konvencija je da imena promenljivih sa statičkim životnim vekom
počinju velikim početnim slovom.
