...
\begin{itemize}
  ...
  \item \textbf{Node16}: u ovom slučaju se koriste SIMD instrukcije.
        ...
        dužine, ali čiji elementi su heksadekadne vrednosti \texttt{0}
        i \texttt{FF}, u zavisnosti da li su elementi na odgovarajućoj
  ...
  \item \textbf{Node48}: indeks narednog čvora je upisan u vektoru
        ...
        vrednost bajta pretrage. Ukoliko taj ključ nije unet,
